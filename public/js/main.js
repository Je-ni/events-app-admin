...
$(function () {
  ...
  $('body').on('click', '.chat-btn a', function () {
    add_full_chat_message($('.chat-input input'));
    return false;
  });
  $('body').on('keypress', '.chat-input input', function (e) {
    if (e.which == 13) {
  ...
  // #16. OUR OWN CUSTOM DROPDOWNS 
  $('body').on('mouseenter', '.os-dropdown-trigger', function () {
    $(this).addClass('over');
  });
  $('body').on('mouseleave', '.os-dropdown-trigger', function () {
  ...
  $('body').on('click', '.todo-sidebar-section-toggle', function () {
  ...
  $('body').on('click', '.todo-sidebar-section-sub-section-toggler', function () {
  ...
  // Complete/Done
  $('body').on('click', '.task-btn-done', function () {
    $(this).closest('.draggable-task').toggleClass('complete');
    return false;
  });

  // Favorite/star
  $('body').on('click', '.task-btn-star', function () {
  ...
  // #19. Fancy Selector
  $('body').on('click', '.fs-selector-trigger', function () {
  ...
  $('body').on('click', '.autosuggest-search-activator', function () {
  ...
  $('body').on('keydown', '.search-suggest-input', function (e) {
  ...
  $('body').on('click', '.close-search-suggestions', function () {
    $('.search-with-suggestions-w').fadeOut();
    return false;
  });

  // #24. Element Actions
  $('body').on('click', '.element-action-fold', function () {
